...
class Hybrid_Provider_Adapter
{
  ...
  /* Set to false if the operation doesnt require authentication */
  ...
  /**
   * Getter and setter for requiresLogin flag
   * @param type null|boolean
   * @return void|boolean
   */
  function requiresLogin($value = null)
  {
    if ($value !== null) {
	...
	*/
	public function __call( $name, $arguments )
	{
		...
		if ($this->requiresLogin() && ! $this->isUserConnected()){
