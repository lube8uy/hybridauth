...
class Hybrid_Auth
{
	...
	*/
	...
	public static function basicProfile( $providerId, $network_user_id )
	{
		Hybrid_Logger::info( "Enter Hybrid_Auth::basicProfile( $providerId )" );
    $adapter = Hybrid_Auth::getAdapter( $providerId );
    $adapter->requiresLogin(false);
    $val = $adapter->getBasicInfoById($network_user_id);
    $adapter->requiresLogin(true);
    return $val;
	}
